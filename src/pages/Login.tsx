    ...
    >
      ...
      <div className="rounded-3xl bg-[#151021]/80 backdrop-blur-xl border border-white/10 p-8 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-white/50">Sign in to access your workspace</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-12 py-3.5 rounded-2xl bg-white/5 border ${
            ...
            {errors.password && <p className="text-rose-400 text-sm mt-1">{errors.password}</p>}
          </div>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 rounded border-white/20 bg-white/5 text-[#ff0088] focus:ring-[#ff0088]/50"
              />
              <span className="text-sm text-white/60">Remember me</span>
            </label>
            <button type="button" className="text-sm text-[#ff0088] hover:text-[#ff1493]">
              Forgot password?
            </button>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <span className="px-4 bg-[#151021] text-sm text-white/30">or continue with</span>
            </div>
          </div>

          <button
            type="button"
            className="w-full py-3.5 rounded-2xl bg-white/5 border border-white/10 text-white font-medium hover:bg-white/10 transition-colors flex items-center justify-center gap-3"
          >
        ...
        <p className="text-center text-sm text-white/50 mt-6">
          ...
          <Link to="/signup" className="text-[#ff0088] hover:text-[#ff1493] font-medium">
            Create account
          </Link>
        </p>
      </div>
